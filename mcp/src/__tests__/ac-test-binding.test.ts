...
describe('buildTargetedTestCommand', () => {
  it('should generate vitest command for node', () => {
    const bindings = [
      {
        acId: 'AC-1',
        testFile: '__tests__/user.test.ts',
        testName: 'should return 400',
        language: 'node',
      },
    ];
  ...
  it('should generate maven command for java', () => {
    const bindings = [
      {
        acId: 'AC-1',
        testFile: 'src/test/java/UserServiceTest.java',
        testName: 'shouldReturn400',
        language: 'java',
      },
    ];
    const cmd = buildTargetedTestCommand(
...
describe('boundary: runAcBoundTests empty bindings', () => {
  it('TC-B-12: should return empty Map for empty bindings array', async () => {
    ...
    const results = await runAcBoundTests(
      [],
      tempDir,
      'node',
      'npx vitest run'
