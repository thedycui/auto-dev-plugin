...
// ---------------------------------------------------------------------------
// INIT Marker Parsing (Tamper-proof original commands)
// ---------------------------------------------------------------------------

export interface InitMarkerData {
  buildCmd: string;
  testCmd: string;
  skipE2e: boolean;
  mode: string;
 ...
 */
export function validateAcJson(acContent: string): AcValidationResult {
  let parsed: unknown;
  try {
...
// ---------------------------------------------------------------------------
// AC Integrity Validation (Phase 6 pre-check)
// ---------------------------------------------------------------------------

export interface AcIntegrityResult {
  valid: boolean;
  error?: string;
}
