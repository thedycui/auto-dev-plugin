...
describe('AcceptanceCriteriaSchema', () => {
  ...
  it('should reject invalid layer value', () => {
    const input = {
      version: 1,
      criteria: [{ id: 'AC-1', description: 'test', layer: 'invalid-layer' }],
    };
  ...
  it('should accept missing structuralAssertions (optional)', () => {
    const input = {
      version: 1,
      criteria: [{ id: 'AC-1', description: 'test', layer: 'manual' }],
    };
    ...
    const criteria = [
      {
        ...
        description: 's1',
        layer: 'structural',
        structuralAssertions: [{ type: 'file_exists', path: 'a.txt' }],
      },
      {
        id: 'AC-2',
        description: 's2',
        layer: 'structural',
        structuralAssertions: [{ type: 'file_exists', path: 'b.txt' }],
      },
